...
# 路由注册（后续逐步添加）
from app.api.routes import auth, users, conversations, messages  # noqa: E402
from app.api.routes import favorites, feedbacks, admin, logs, stats, context  # noqa: E402
