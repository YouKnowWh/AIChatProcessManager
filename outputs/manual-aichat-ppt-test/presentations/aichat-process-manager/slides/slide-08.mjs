...
export async function slide08(presentation, ctx) {
  ...
  card(ctx, slide, 475, 185, 330, 145, "角色管理", "普通用户维护自己的 AI 角色；管理员统一管理角色状态和平台可用性。", colors.amber);
  ...
  card(ctx, slide, 870, 395, 330, 145, "可扩展接口", "DeepSeek 适配层、流式响应、统计图表、权限细化都可在当前结构上继续扩展。", colors.red);
  footer(ctx, slide, 8);
  return slide;
}
